...
struct IosTextTests {
    @Test func printableAsciiIncludingSymbolsIsHidTypeable() async {
    ...
    @Test func nonAsciiIsNotHidTypeable() async {
    ...
    @Test func controlCharsAndEmptyAreNotHidTypeable() async {
