...
**This file is where Reticle is going**: what is left, in priority order, and which
decisions are already settled so they are not re-litigated. `AGENTS.md` maps the
other documents and what each one owns.

Status: 2026-08-07, tracking 0.20.0. The capture/drive/evidence backbone is complete
